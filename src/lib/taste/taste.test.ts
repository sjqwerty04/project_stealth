...
describe('buildRecommendContext', () => {
  it('fills the four context buckets from diary evidence', () => {
    const context = buildRecommendContext({
      ...
      rated: [
        { title: 'Heat', movieId: 949, verdict: 'liked', at: 200 },
        { title: 'Transformers', verdict: 'nope', at: 100 },
        { title: 'Unrated', verdict: 'liked' },
      ],
  ...
  it('puts unrated watches in history as 3', () => {
    const context = buildRecommendContext({
      ...
      favorites: [],
      disliked: [],
      rated: [{ title: 'Heat', movieId: 949, verdict: null, at: 1 }],
      watchlist: [],
      skipped: [],
      searches: [],
      patterns: [],
...
describe('applyTasteEvent', () => {
  it('keeps a growing history and points at the event', () => {
    const events: TasteEvent[] = [
      ...
      { type: 'verdict', movieId: 500, title: 'Drive', verdict: 'liked', source: 'rec' },
