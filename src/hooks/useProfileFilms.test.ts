...
describe('profileFilms', () => {
  it('turns onboarding picks into poster candidates', () => {
    expect(
      ...
      { title: 'The Dark Knight', poster: 'https://image.tmdb.org/t/p/w500/qJ2tW6.jpg' },
      { title: 'The Prestige', poster: 'https://cdn/prestige.jpg' },
      { title: 'Transformers', poster: 'https://image.tmdb.org/t/p/w500/tf.jpg' },
    ]);
  });
