  ...
  <div className="min-h-screen bg-base flex flex-col items-center justify-center px-6">
   <div className="w-full max-w-sm text-center space-y-6">
    <div className="flex justify-center">
     <div className="w-20 h-20 bg-blue-500/20 flex items-center justify-center">
      <Mail className="w-10 h-10 text-blue-400" />
     </div>
    </div>

    <div className="space-y-2">
     <h1 className="text-2xl font-bold text-fg">Check your email</h1>
    ...
    <div className="space-y-3">
     <button
      ...
      disabled={checking}
      className="w-full bg-white hover:bg-gray-200 text-black font-semibold py-4 flex items-center justify-center gap-2 transition-all disabled:opacity-50"
     >
      {checking ? (
     ...
     <button
      ...
      className="w-full bg-gray-900 hover:bg-gray-800 border border-line text-fg font-medium py-4 flex items-center justify-center gap-2 transition-all disabled:opacity-50"
     >
      {resending ? (
       <Loader2 className="w-5 h-5 animate-spin" />
      ) : (
