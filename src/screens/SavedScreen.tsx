    ...
    <div className="min-h-screen bg-[#09090b] font-sans text-gray-100 flex flex-col max-w-md mx-auto shadow-2xl overflow-hidden border-x border-gray-800">
      <div className="bg-[#09090b]/90 backdrop-blur-md px-4 py-4 flex items-center gap-4 sticky top-0 z-10 border-b border-gray-800">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">{items.length} film{items.length !== 1 ? 's' : ''}</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-300 mb-2">Nothing saved yet</h3>
          ...
          <div className="grid grid-cols-3 gap-3">
            {items.map((item) => (
              ...
              >
                ...
                <div className="absolute top-2 right-2 w-7 h-7 rounded-full flex items-center justify-center bg-blue-500 text-white">
          ...
          <div className="bg-[#18181b] w-full max-w-sm rounded-2xl p-6 shadow-2xl z-50 relative border border-gray-800">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3 rounded-xl font-medium bg-green-600 hover:bg-green-500 text-white flex items-center justify-center gap-2"
              >
